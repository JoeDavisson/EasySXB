...
Getting Started
---------------
First, obtain the port name (usually something like /dev/ttyUSB0). You may have to re-check this if you reconnect the board or reboot the system. Before connecting, choose the board type from the "Mode" menu.
